...
Musubi.ready(function(context) {
    ...
    $("#submit").click(function(e) {
      ...
      var start_obj_DbObj = musu.appContext.feed.query("type='note'")[0][0];
      //while (!(start_obj_DbObj instanceof SocialKit.DbObj))
      //{
      //	start_obj_DbObj = musu.appContext.feed.query("type='note'")[0][0];
      //}
      console.log("finished!");
      console.log("start obj is: " + start_obj_DbObj.toString());
