...
Musubi.ready(function(context) {
    ...
    $("#start").click(function(e) {
      ...
      style += "color:red;";
      var text = "<img src='http://divyahansg.github.com/musubi-truth-dare/musubi/apps/header_1.png'>"//context.user["name"] + " started a game of Truth or Dare! Run the app to join!";
